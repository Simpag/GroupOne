...
public class RTSessionInfo {
    ...
    public string GetHostURL{ get { return this.hostURL; } }
    private string acccessToken;
    public string GetAccessToken{ get { return this.acccessToken; } }
    private int portID;
    public int GetPortID{ get { return this.portID; } }
    private string matchID;
    public string GetMatchID { get { return this.matchID; } }
